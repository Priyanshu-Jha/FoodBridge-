...
public class DemoDataSeeder implements CommandLineRunner {
        ...
        public void run(String... args) {
                ...
                User admin = createUser(
                                "demo.admin@foodbridge.local",
                                "Demo@123",
                                "FoodBridge Admin",
                                "9000009000",
                                "HQ Control Center, Pune",
                                Role.ADMIN,
                                18.5209,
                                73.8560,
                                geometryFactory);

                userRepository.saveAll(List.of(donorOne, donorTwo, ngoOne, ngoTwo, admin));
                ...
                FoodListing availableOne = createDonation(
                                ...
                                "Sunrise Bakery, 12 Main Road, Pune",
                                18.5210,
                                73.8580,
                                null,
                                null,
                ...
                FoodListing availableTwo = createDonation(
                                ...
                                null,
                                FoodStatus.AVAILABLE,
                                "Green Bowl Restaurant, 88 FC Road, Pune",
                                18.5340,
                                73.8455,
                                null,
                                null,
                ...
                log.info("Day 28 demo seed completed: 5 users and 4 demo donations created.");
